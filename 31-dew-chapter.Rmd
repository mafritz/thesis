...
The GEW was initially created as an attempt to combine the widespread use of natural language words to describe the emotional experience with the precision of the dimensional approach in quantifying representative features of that same experience [@schererWhatAreEmotions2005]. At that time, most self-reporting tools adopted either one of the strategies, but did not integrate both in a cohesive way.

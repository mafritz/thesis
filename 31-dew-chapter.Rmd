...
The GEW was initially created under the assumption that it would be interesting to combine the widespread use of natural language words to describe the emotional experience with the precision of the dimensional approach in quantifying representative features of that same experience [@schererWhatAreEmotions2005].

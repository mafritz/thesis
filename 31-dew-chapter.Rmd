...
(ref:original-list-eatmint-emotions-caption) List of the 20 emotion adjectives used as buttons in the EAT. Our translation from the original French word in parentheses -- partially based on a document by the [@genevaemotionresearchgroupAppendixLabelsDescribing1988] -- is limited to the contribution's purpose. The order in the table reflects the order of the buttons in the interface.

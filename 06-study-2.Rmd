...
As a reminder, participants to the study were enrolled in a blended course organized over three periods of time. During the first period, students had the occasion to get familiar with distance, technology enhanced learning. When they filled the *Expectancy* survey, they therefore already had a fresh, first-hand experience of the difficulties they had to face during the remote period. In this regard, they had the highest expectations about the usefulness of an EAT for the *Understanding Others*, and *Self-Other Comparison*, that is, the two more socially-oriented dimensions. For the two more self-oriented dimensions, *Self-Understanding* and *Self-Regulation*, expectations were only moderate to low. The *Affordance* dimension was rated high, suggesting that the tool is expected to serve its function of prompting learners to share their emotions. Finally, the *Frequency* and *Social Presence* dimensions are more difficult to assess, since they are the two dimensions on which the two classes have a lesser convergence. Frequency of use is notoriously a user-experience dimension that is difficult to foresee: oftentimes it is overestimated, as it is corroborated by the overall study, since the actual use turned out to be very limited. The moderate expectations for *Social Presence*, combined with higher expectations for the socially-oriented dimensions, may suggest that learners consider the EAT as a potential source of social reference rather than a way to perceive the presence of others. 

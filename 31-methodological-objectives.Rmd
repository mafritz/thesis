# Extending the Dynamic Emotion Wheel To a Multi-Purpose Emotion Awareness Tool for Practictioners and Researchers

- Extension of the DEW
- More than two dimensions
- Appraisal vs. dimensions
- Comparaison between studies
- Citing cherer on utilitarian vs other emotions (e.g. depends on students finding prototypical appraisals in school)
- Divide improvement from theoretical and practical perspectives

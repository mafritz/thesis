...
This chapter describes the second empirical contribution of the thesis, which investigates the longitudinal use of an EAT in asynchronous and non-collaborative learning settings made by two classes of a blended Master in education technology.

## Study Rationale

Even though there is nowadays a consistent agreement in considering emotions as bounded episodes unfolding over relatively short time [@sanderModelsEmotionAffective2013; @schererStudyingAppraisaldrivenEmotion2019; @pekrunIntroductionEmotionsEducation2014], the effects of emotional experiences also have consequences on the long term [@schererEvidenceExistenceEmotion2021; @rimePartageSocialEmotions2005; @pekrunEmotionsSchool2018; @brackettPermissionFeelUnlocking2019]. As stated by appraisal theories of emotions, for instance, emotions are elicited by the evaluation of events considered of major concern for the organism, and that evaluation can over time present regular patterns, for which a person may be more prone to evaluate events according to stable perspectives [@schererEvidenceExistenceEmotion2021]. Emotions play also a prominent role in the formation of meaningful and stable relationships with others [@rimePartageSocialEmotions2005; @rimeEmotionElicitsSocial2009; @vankleefEmotionalCollectivesHow2015; @barsadeGroupAffect2015; @smithCanEmotionsBe2007]. As already mentioned in Chapter \@ref(general-affective-background), there is also a growing consensus in learning and educational sciences to take a more holistic and integrated approach to students' emotions at various levels, from the everyday experience to the creation of curriculum that foster socio-affective competences [@pekrunEmotionsSchool2018; @brackettPermissionFeelUnlocking2019; @pekrunInternationalHandbookEmotions2014; @henritius2019].
...
The interest of the convenience sample is, ironically, its potential inconvenience. In fact, if the tool is adopted and considered as useful, results may be biased by the convenience sample, and must therefore be taken with caution. On the other hand, if the tool is not adopted and considered of scarce usefulness, then the shortcomings are amplified, since even learners with an interest, habit, and technical know-how would not adopt it.
...
```{r s2-dew-interface-figure}
#| fig.align="center",
#| fig.cap="(ref:s2-dew-interface-caption)",  
#| fig.scap = "Study 2: Interface of the EAT",
#| out.width="50%"
knitr::include_graphics(
  here::here("figure/s2/dew-interface.png")
)
```
...
eau_description |> 
  kable(
    ...
    caption.short = "Study 2: EAU scale composition",
    longtable = TRUE,
    booktabs = TRUE,
...
```{r s2-graph-emotions-expressed-boxplot}
#| fig.align="center", 
#| fig.cap="(ref:s2-graph-emotions-expressed-boxplot-caption)",
#| fig.scap = "Study 2: Number of emotions expressed",
#| fig.width=4, 
#| fig.height=2.5, 
...
```{r s2-graph-expressed-emotions-over-time}
#| fig.align="center", 
#| fig.cap="(ref:s2-graph-expressed-emotions-over-time-caption)",
#| fig.scap = "Study 2: Evolution of the number of emotions expressed",
#| fig.width=5,
#| fig.height=2.5
...
```{r s2-eda-dimensions-dispersion-graph}
#| fig.align="center",
#| fig.cap="(ref:s2-eda-dimensions-dispersion-graph-caption)", 
#| fig.scap = "Study 2: Sensibility of EAU rating",
#| out.width="80%"
...
(ref:s2-mlm-eau-caption) Results of a Type III ANOVA on the fitted multilevel linear model using Kenward-Roger approximation for computing the *p*-value. The dependent variable is the individual rating on each item of the EAU scale at every administration of the survey.
...
```{r s2-graph-dimensions-and-survey}
#| fig.align="center", 
#| fig.cap="(ref:s2-graph-dimensions-and-survey-caption)",
#| fig.scap = "Study 2: Longitudinal EAU rating",
...
### Structure and Reliability of the Emotion Awareness Usefulness Scale
...
: Study 2: Reliability measures of the EAU scale
...
> --- @revellePsychProceduresPsychological2021, documentation of the R package
...
```{r s2-scree-plot-graph}
#| fig.align="center", 
#| fig.cap="(ref:s2-scree-plot-caption)",
#| fig.scap = "Study 2: Scree plot of EAU dimensions",
#| out.width = "60%"
...
```{r s2-factor-analysis-graph}
#| fig.align="left", 
#| fig.cap="(ref:s2-factor-analysis-caption)",
#| fig.scap = "Study 2: Factors loading of the EAU"
omega.diagram(s2.eau.fa, main = "", marg = c(0,0,0,0))
```
...
```{r s2-sus-items-graph}
#| fig.align="center", 
#| fig.cap="(ref:s2-sus-items-graph-caption)",
#| fig.scap = "Study 2: Rating of the SUS items",
#| out.width = "80%"
...
```{r s2-recollection-feelings-graph}
#| fig.align="center", 
#| fig.cap="(ref:s2-recollection-feelings-graph)",
#| fig.scap = "Study 2: Recollected frequencies of expressed subjective feelings",
#| out.width = "100%"
...
The *Affordance* dimension was rated high ($M_{total}=6.57$), suggesting that the tool is expected to serve its function of prompting learners to share their emotions. This seems to corroborate the need for a dedicated tool targeting specifically emotions [@brackettRULERTheoryDrivenSystemic2019; @brackettEnhancingAcademicPerformance2012; @brackettPermissionFeelUnlocking2019], but does not implicate the benefit of implementing an emotional structure into it, since ratings with the *Demo* survey did not increase the expectations.

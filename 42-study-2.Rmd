...
The scree test pictured in Figure \@ref(fig:sc-scree-plot-graph) suggests that three factors account for a fair amount of variance, with small gain achieved by adding a fourth or a fifth dimension.

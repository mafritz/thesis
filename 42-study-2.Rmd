...
Taking advantage of the fact that two classes will use the EAT under very similar conditions -- and assuming no systematic factor at play determining particular type of students in one class compared to the other -- wide differences between one class and the other should corroborate the effect of interaction rather than individual characteristics alone. As previously stated, though, the exploratory nature of the study lacks the precision to quantify what is meant by *wide* differences. Consequently, results will be interpreted with respect to the available measures.

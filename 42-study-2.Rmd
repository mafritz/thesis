...
The toolbox was configured to take into account the longitudinal use of the EAT, which may happen at any time during the day, and with any number of students connected at the same time. The configuration of the Dynamic Emotion Wheel (DEW), depicted in Figure \@ref(fig:s2-dew-interface-figure), is thus implemented as follows.

For the expressing-displaying function of awareness, the same EATMINT circumplex was adopted. As a reminder, this affective space comprises 20 emotions organized over the two appraisal dimensions *Valence*, prompted with the question *is the situation pleasant?*, and *Control/Power*, prompted with the question *is the situation under your control?*. Both dimensions were characterized by two opposite poles, labeled *not at all* and *yes absolutely*. The choice and disposition of the subjective feelings is thoroughly depicted in Section \@ref(eatmint-circumplex).

For the perceiving-monitoring function of awareness, three *word clouds* were implemented. In a *word cloud*, words are depicted in a font whose size is proportional to the number of occurrences of that world in a specific context, so that the more frequently used words appear bigger than the less frequently used ones. The perceiving-monitoring interface of the EAT comprised the following elements:
...
The combination of the three word clouds sustain the two main social functions of emotions identified by Fischer and Mastead [-@fischerSocialFunctionsEmotion2016]: the affiliation and the distancing function. The top and center word clouds allow participant to compare her own emotions (top) with that of the class (center). In this way, she can position herself with respect to the other students (distancing). The bottom word cloud groups all the emotions of the class and is therefore more related to the affiliation function of emotions.
...
eau_description <- tibble::tribble(
  ...
  "The frequency of use is a dimension used in different scales pertaining to Human-Computer Interaction and User Experience. The more frequently a tool is used the more useful it is perceived especially when the use is voluntary.",
  "2",
  "Affordance",
  "The use of the tool prompted me to share my emotions.", "Affordance in this context broadly refers to the actions available through the EAT and where they take place. The presence of an EAT may prompt users to share their emotions something they would not do without the presence of the tool",
  "3",
  "Social Presence",
  "The use of the tool allowed me to feel less lonely during remote learning periods.",
  "Social presence is a pivotal dimension in remote learning providing support for learners isolation and feeling of loneliness. Perceiving the emotions of colleagues can help learners to remember there are others in the same condition as they are.",
  "4",
  "Self-Understanding",
  "The use of the tool allowed me to better understand my emotions.",
  "Having emotions a strong influence on intra-personal functions, the presence of an EAT may contribute to a better self-assessment of the situation and its consequences on learners' behavior.",
  "5",
  "Understanding Others",
  "The use of the tool allowed me to better understand the emotions of my colleagues.",
  "The presence of the emotions of colleagues through the EAT may inform learners about what others are experiencing during the remote learning periods providing information to build and update a mental model of the causes and consequences on their behavior",
  "6",
  "Self-Other Comparison",
  "The use fo the tool allowed me to compare my emotions with those of my colleagues.",
  "Comparing one's own emotions with that of the colleagues can provide useful information especially in situation of incertitude. The presence of the EAT may facilitate and prompt this comparison.",
  "7",
  "Self-Regulation",
  "The use of the tool allowed me to regulate my emotions.",
  "Emotion regulation is a pivotal phenomenon that allows learners to modify their emotional experience using different strategies such as suppression or reappraisal in order to maintain instrumental emotional states and modify disruptive ones. The presence of the EAT both in terms of learners own emotions and that of the colleagues may facilitate regulatory processes."
)

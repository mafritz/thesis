# Emotional Awareness in Computer-Mediated Learning Environments: Assumptions, Mechanisms, and Methodological Issues
...
Whereas the previous chapter provided a *bona fide* overview of the growing consensus in integrating affective phenomena into computer-mediated learning environments, this chapter delves  more specifically into the rationale behind endowing learners in a computer-mediated learning environment with an Emotion Awareness Tool (EAT), that is, the reasons why an EAT can be beneficial to learners. This chapter provides an overview of different aspects, as well as their intrinsic complexity, that must be faced when considering the possibility of endowing a computer-mediated learning environment with explicit emotional awareness.

## Defining Emotional Awareness and Emotion Awareness Tools

Emotion or emotional awareness in computer-mediated learning environments is often defined, somehow implicitly, as information about one's own emotions and/or that of other learners sharing the same environment [@cerneaSurveyTechnologiesRise2015; @feidakisEndowingElearningSystems2011; @lavoueEmotionAwarenessTools2020]. For instance, as stated in the previous chapter, Feidakis and colleagues [-@feidakisReviewEmotionAwareSystems2016, p. 217] define emotion awareness, mainly from a *technical* viewpoint, as "the *implicit* or *explicit collection of emotion data* and the *recognition* of *emotion patterns*" (italics in the text). Lavoué and colleagues, on the other hand, [-@lavoueEmotionAwarenessTools2020] propose different definitions, partially derived from clinical psychology. They first propose a definition based upon @bodenFacetsEmotionalAwareness2015, which identifies emotional awareness as "the ability to perceive, identify, and understand emotions" [@lavoueEmotionAwarenessTools2020, p. 270]. Later in their article, Lavoué and colleagues (*ibid.*) propose another definition, based upon Rieffe and colleagues [-@rieffeEmotionAwarenessInternalising2008], referring to emotional awareness as "the attentional process by which individuals identify, explain and differentiate between their own emotions as well as the others’ emotions" [@lavoueEmotionAwarenessTools2020, p. 270]. These two definitions resonate with socio-emotional competences briefly illustrated in the previous chapter. Finally, even further below their article, Lavoué and colleagues (*ibid.*) provide a more technical definition of emotion awareness tools: "[e]motion awareness tools can be defined as tools that display information on own’ [sic] own or partners’ emotions, circumstances and antecedents" [@lavoueEmotionAwarenessTools2020, p. 284]. Compared to the more abstract definition of Feidakis and colleagues (*ibid.*), Lavoué and colleagues (*ibid.*) imply that the tool shall also provide information about circumstances and antecedents.

Provisionally, an abstract definition of emotional awareness and, by extension, emotion awareness tool may better serve the multi-purpose vocation of an EAT, as advocated in the present contribution. As a consequence, an EAT is hereafter referring to a technological artifact, embedded in the computer-mediated learning environment, that provides information about one's own emotions and/or emotions of other learners sharing the same environment. 
...
(1) Intra-personal role of emotion
(2) Inter-personal role of emotion
(3) Emotion conveyed in computer-mediated learning environment

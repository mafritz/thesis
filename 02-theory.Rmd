...
These reasons, thus, advocate the adoption of a prescriptive, theory-driven approach to emotion definition and the next subsection will therefore assess some *candidates*. In this regard, though, it would be helpful to dispose of a provisional definition of emotion as a means to better assess both theories and criteria of selection. Despite the multiplicity of definition and approaches to emotion definition that this subsection could only sketch, over the years a certain agreement has emerged on some characteristics of emotion. 

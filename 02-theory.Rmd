...
Issues about the definition of emotion are rooted in historical, cultural and epistemological differences, within and across disciplines and approaches -- see @dixonPassionsEmotionsCreation2003 and @plamperHistoryEmotionsIntroduction2015 for overarching perspectives, or @sanderModelsEmotionAffective2013 for a more concise introduction. Some of the broader controversies regarding emotion can be encapsulated in onion layers. From the outset to inset, controversies may concern:

* the connection and discrimination between emotion and other phenomena of the mind such as intelligence, rationality, consciousness or various forms of cognition [@broschImpactEmotionPerception2013; @leventhalRelationshipEmotionCognition1987; @liebermanBooConsciousnessProblem2019; @rollsEmotionDecisionmakingExplained2014; @becharaRoleEmotionDecisionmaking2004; @pessoaCognitiveemotionalBrainInteractions2013; @murphyIntelligenceInterpersonalSensitivity2011; @saloveyEmotionalIntelligence1990]; 
* the connection and discrimination between emotion and other affect-related phenomena such as moods, preferences, attitudes, motivation, desires, feelings, sentiments, passions, and so on [@linnenbrink-garciaAdaptiveMotivationEmotion2016; @schererWhatAreEmotions2005; @dixonPassionsEmotionsCreation2003; @schwarz2003mood; ]; 
* the connection and discrimination between phenomena that are considered as emotion -- such as *anger*, *fear*, or *happiness* -- and can therefore be categorized in various taxonomies [@fehrConceptEmotionViewed1984; @fontaineGlobalMeaningStructure2013; @russellCoreAffectPsychological2003; @sanderModelsEmotionAffective2013; @pekrunInternationalHandbookEmotions2014]; 
* the connection and discrimination of the whole unfolding mechanism, from causes to consequences [@grossEmotionRegulationAffective2002; @moorsTheoriesEmotionCausation2009; @russellCoreAffectPsychological2003], representing the bounded emotion (e.g. what *is* anger?).
...
These reasons, thus, advocate the adoption of a theory-driven approach to emotion definition. The next subsection will therefore assess some *candidates* among different emotion theories and adopt one as the prescriptive desideratum for guiding the implementation of an EAT. 

### Theories of Emotions

As one may expect from the complexity in defining an emotion outlined in the previous subsection, there are a multitude of emotion theories and also of taxonomies that try to categorize them [for a recent overview, see @moorsTheoriesEmotionCausation2009; @sep-emotion]. Adopting a bird-view perspective spanning philosophy and affective sciences, Scarantino and de Sousa [@sep-emotion], for instance, identify three traditions in which most of emotion theories can be divided in: (1) the Feeling Tradition, which considers the conscious experience of an emotion as the fundamental characteristic; (2) the Evaluative Tradition, which focuses on how emotion consists in, or is crucially defined by the way eliciting stimuli are evaluated; and (3) the Motivational Tradition, which identifies emotion with specific internal states driven by want or need to satisfy a goal.

In psychology more specifically, the investigation of emotion has been characterized mainly by three major theoretical positions represented by: (1) basic emotion theories, (2) constructivist emotion theories; and (3) appraisal emotion theories. This subsection provides a brief outline of each theory -- for a more extensive comparison see @sanderModelsEmotionAffective2013 and @schererEmotionTheoriesConcepts2009 -- and relates them with hypothetical consequences in the implementation of an EAT.

...
```{r s3-appraisal-density-graph, fig.align='center', fig.cap="(ref:s3-appraisal-density-caption)"}
...
```{r s3-appraisal-evaluation-graph, fig.align='center', out.width="80%", fig.cap="(ref:s3-appraisal-evaluation-caption)"}
...
```{r s3-frequency-graph, fig.align='center', out.width="60%", fig.cap="(ref:s3-frequency-graph-caption)"}
...
```{r s3-theoretical-feelings-graph, fig.align='center', out.width="100%", fig.height=9, fig.cap="(ref:s3-theoretical-feelings-graph-caption)", fig.pos="p"}
...
```{r s3-empirical-feelings-graph, fig.align='center', out.width="100%", fig.height=9, fig.cap="(ref:s3-empirical-feelings-graph-caption)", fig.pos="p"}
...
```{r s3-empirical-feelings-comparison-graph, fig.align='center', out.width="100%", fig.height=9, fig.cap="(ref:s3-empirical-feelings-comparison-graph-caption)", fig.pos="p"}
...
```{r s3-sus-items-graph, fig.align='center', out.width="100%", fig.cap="(ref:s3-sus-items-graph-caption)", fig.pos="H"}
s3.sus_items.graph
```
...
Given the importance that is attributed to the affective experience by the EAT itself, it would be coherent to follow through with a more holistic assessment, integrating usability measures with scales such as the AttrakDiff [@hassenzahlAttrakDiffFragebogenZur2003], the UEQ [@laugwitzConstructionEvaluationUser2008], or the meCUE [@mingeMeCUEQuestionnaireModular2017]. These scales provide a more thorough assessment of a technological device, considering for instance also the look-and-feel of the tool, which is known to not only impact the perception of the tool, but also its use [@lallemandMethodesDesignUX2017; @tullisMeasuringUserExperience2013a; @vermeerenUserExperienceEvaluation2010].

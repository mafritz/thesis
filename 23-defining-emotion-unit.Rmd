...
* *Implications/Consequences*: what are the implications or consequences of this event and how do they affect my well-geing and my imeidate or long-term goals?
...
(ref:tf-cpm-secs-caption) Stimulus evaluation cjecks, organized in four groups, illustrated with typical features describing the event or the effects on the person. Retrieved from original Table 1 in @schererNatureDynamicsRelevance2013, p. 151
```{r tf-cpm-secs}
tf.secs <- tibble(
...
The evaluation of SECs can be executed at various levels of processing, recently identified by Scherer [-@schererNatureDynamicsRelevance2013] in four levels: 

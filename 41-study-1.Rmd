# Emotion Awareness in Synchronous and Collaborative Settings {#study-1}
...
(ref:conditions-ea-model-caption) Comparison of the three condition with respect to the abstract model illustrated in Section @ref(abstract-model-of-ea)

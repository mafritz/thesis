...
The following graph illustrates the result of applying this generative model to 26 simulated emotions. For each emotion, the two appraisal values and the lexicalized emotions are provided.

...
The thesis adopted an overall perspective aiming more broadly to the construct and internal validity of emotional awareness. Such an attempt, especially in an individual contribution at the doctoral stage, stretches over a wide domain of inter-dependent and inter-disciplinary aspects. As a consequence, the work certainly highlights a number of limitations or uncompleted steps in the process. This concluding chapter thus starts by pointing out three main limitations of the present work. It then provides a glimpse for three different perspectives on future development. Finally, some thoughts about the overall work are proposed by the author.

## Limitations

Three main limitations are identified in the present contribution. The first relates to the absence of elements that are more prominently related to learning. The second concerns the lack of empirical data, which have fostered a more severe assessment of the tool. Finally, in spite of the interaction and user-centered approach adopted by the thesis, few researchers or pratictioners have been implicated in the process.
...
On the practical side, this shift was incidentally reinforced by the pandemic: a third study ready to be carried out was first stopped by the lock-down and then adapted to be conducted online. Finally, it was postponed for in the meantime I had been focusing on the implementation of the EAT from a broader perspective. Since one of the aim of pursuing a thesis in psychology was to reorient myself from a web developement background, this limitation of the thesis is the one that is personally more deceiving.

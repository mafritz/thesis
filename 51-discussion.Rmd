...
### Is It Worth Having aComputational Model Determined by Appraisal Theories of Emotion?
...
This is clearly a major shortcoming both from a user experience and pedagogical perspective. For the former, the learner is asked for an explicit action that seems to add little independent value. As a consequence, the action is redundant and in contrast with the general outlook in user experience advocating parsimony and relevance in prompting user efforts. For the latter, learners seem to gain little understanding from the Control/Value reflection, even though, at a theoretical level, this is a major determinant in discriminating emotional experience, and also a relevant pedagogical dimension in influencing learning processes and outcomes.

In Chapter \@ref(study-3) I have already suggested some possible solutions to the problem. I think that the possibility to exclude a *pure* Valence dimension may be the most promising one, forcing learners to evaluate the situation according to a different perspective. The extension of the computational model to multi-dimensional affective spaces illustrated in Chapter \@ref(computational-model), unfortunately not tested in the present contribution, is also an attempt in the direction of a more accurate differentiation of the emotional experience. For instance, there may be cognitive evaluations of the situation at hand that are more or less relevant depending on characteristics of the learning context. This allows researchers and practitioners to target more specifically emotions linked to learning, as it is the case of epistemic emotions, which have only recently been put under the radar.

In the meantime, the solutions I have proposed are all of a *more of the same* nature, whereas the results obtained warrant a more profound analysis of the model. In other words, it is legitimate and necessary to ask whether the presence of the computational model driven by appraisal theories of emotion really adds something to the EAT in terms of facilitating emotional awareness. To answer this question, I will first compare three different sort of computational models.
...
This kind of model is disruptive compared to the previous ones, since there is a form of inverse probability at play. In the theory driven and data-driven approaches, we are interested in the probability of experiencing a certain emotion given the evaluation at hand, that is, $P(emotion|evaluation)$. On the contrary, with a scripting strategy, we are interested in inducing a cognitive evaluation that is driven by a targeted emotion, for that particular emotion to be experienced by learners -- that is, $P(evaluation|{target} \space {emotion})$. It is therefore a different perspective that conveys to the instructional design the role of a demiurge that weaves the fabric of emotional experience in students.

### Theory-Driven Remains the Better Candidate, For Now

In spite of the shortcomings highlighted by the particular theory-driven application in the present contribution, I still consider it the best options, at least at the present stage of knowledge on the role of emotional awareness for reasons I will explain hereafter.

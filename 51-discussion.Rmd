...
In this approach, the likelihood of an expected subjective feeling is derived only by the theoretical model, represented by the affective space. In other words, the model is not influenced neither by contextual factors, nor by the information coming in from the use of the tool through time. This way of considering an emotion is consistent with the abstract idea of an emotion as a *Swiss-knife* that maximizes its usefulness in many different circumstances.
